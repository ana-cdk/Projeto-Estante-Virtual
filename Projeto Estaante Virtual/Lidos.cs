...
{
    public partial class Lidos : Form
    {
        ...
        private string status = "Lido";

        private bool _carregando = true;
        public Lidos(Guid usuarioSelecionado)
        {
            InitializeComponent();
            this.usuarioSelecionado = usuarioSelecionado;
        }
        private void InicializarLido()
        {
        ...
        private void Lidos_Shown(object sender, EventArgs e)
        {
            InicializarLido();
            DTLivro.ClearSelection();
            _carregando = false;
