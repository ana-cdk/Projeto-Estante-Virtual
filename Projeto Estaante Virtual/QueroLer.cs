...
{
    public partial class QueroLer : Form
    {
        ...
        private string status = "Quero Ler";

        private bool _carregando = true;
        public QueroLer(Guid usuarioSelecionado)
        {
            InitializeComponent();
            this.usuarioSelecionado = usuarioSelecionado;
        }
        private void InicializarQueroLer()
        {
        ...
        private void QueroLer_Shown(object sender, EventArgs e)
        {
            InicializarQueroLer();
            DTLivro.ClearSelection();
            _carregando = false;
